                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script Infinitytz Hub X Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Window = Fluent:CreateWindow({
    Title = " Infinitytz Hub X | Blox Fruits",
    SubTitle = "Version 2",
    TabWidth = 160,
...
local Tabs = {
    Main = Window:AddTab({ Title = "Main", Icon = "rbxassetid://85903749106776" }),
    Setting = Window:AddTab({ Title = "Setting", Icon = "rbxassetid://85903749106776" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "rbxassetid://85903749106776" }),
    Player = Window:AddTab({ Title = "Player", Icon = "rbxassetid://85903749106776" }),
    Teleport = Window:AddTab({ Title = "Teleport", Icon = "rbxassetid://85903749106776" }),
    Fruit = Window:AddTab({ Title = "Fruit", Icon = "rbxassetid://85903749106776" }),
    Raid = Window:AddTab({ Title = "Raid", Icon = "rbxassetid://85903749106776" }),
    Race = Window:AddTab({ Title = "Race V4", Icon = "rbxassetid://85903749106776" }),
    Shop = Window:AddTab({ Title = "Shop", Icon = "rbxassetid://85903749106776" }),
	Misc = Window:AddTab({ Title = "Misc", Icon = "rbxassetid://85903749106776" }),
}
local Options = Fluent.Optionsf
do
OrionLib:MakeNotification(
        {
            Name = "Notification",
            Content = "Please Wait For Loading Code",
            Image = "rbxassetid://85903749106776",
            Time = 7
        }
    )
_G.lakala = true

setclipboard("Infinitytz Hub X Is The Best")
...
ImageButton.Image = "http://www.roblox.com/asset/?id=85903749106776"
...
Tabs.Main:AddButton({
        Title = "Infinitytz Hub X Discord Server",
...
Fluent:Notify({
    Title = "Infinitytz Hub X",
    Content = "Thanks For Using Infinitytz Hub X",
    Duration = 8
})
